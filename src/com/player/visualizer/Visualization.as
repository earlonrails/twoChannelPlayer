package com.player.visualizer {
     ...
     *  @public variables
     */
    public var leftBitmapData:BitmapData = new BitmapData(1, 1, true, 0x00000000);
    public var rightBitmapData:BitmapData = new BitmapData(1, 1, true, 0x00000000);
    public var bitmapData:BitmapData = new BitmapData(1, 1, true, 0x00000000);

    /**
     *  @private variables
     */
		private var _leftBitmap:Bitmap = new Bitmap(leftBitmapData);
    private var _rightBitmap:Bitmap = new Bitmap(rightBitmapData);
  	private var _bitmap:Bitmap = new Bitmap(bitmapData);
  	private var _leftSpectrumData:ByteArray = new ByteArray();
    private var _rightSpectrumData:ByteArray = new ByteArray();
    ...
    private var _channel:String = "stereo"; // mono, left, right, stereo
